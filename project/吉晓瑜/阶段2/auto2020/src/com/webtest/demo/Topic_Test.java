...
//		进入排行第一的话题
	...
	public void test_host_manager_topic() {
		...
		webtest.click("xpath=//div[@class='num num-top'][text()='1']");
		webtest.scrollFind1();
		webtest.type("xpath=//span[@id='web_uploader_wrapper_avatar']//input[@name='file']","C:\\Users\\JJIXI\\Desktop\\u.jpg");
		webtest.type("xpath=//span[@id='web_uploader_wrapper_qrcode']//input[@name='file']","C:\\Users\\JJIXI\\Desktop\\u.jpg");
