...
//	新增方法，作用：可以改变标签属性
	public void setAttribute(String locator, String attributeName, String value) {
	...
	public void findClick(String locator) {
		WebElement login=finder.findElement(locator);
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void scrollFind1() {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,800)");
	}
	
	public void scrollFind2(String locator) {
		WebElement login=finder.findElement(locator);
		JavascriptExecutor js = (JavascriptExecutor) driver;
