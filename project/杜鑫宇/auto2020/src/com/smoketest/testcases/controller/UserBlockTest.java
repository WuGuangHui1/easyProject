...
public class UserBlockTest extends BaseTest {
	// 用户与身份模块 首页（注释：该功能项用例测试已完成！已解决：先按照正常顺序执行一遍，会乱序执行测试，但都成功；再标priority执行，按照顺序执行成功
	@BeforeClass
	public void openUrl() {
...
//		WebElement toast = webtest.getElementByXpath("//*[@id='toast-container']/div/div");
	...
	public void test_searchInfo() throws InterruptedException {
		...
		webtest.typeAndClear("xpath=/html/body/div[1]/div/div/section[2]/div/div[2]/div/div[3]/div[3]/div/input", "admin");
		Thread.sleep(1000);
