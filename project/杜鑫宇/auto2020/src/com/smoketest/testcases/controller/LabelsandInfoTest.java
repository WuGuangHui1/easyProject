...
public class LabelsandInfoTest extends BaseTest {
	// 用户与身份模块 标签与资料  （注释：该功能项用例已完成！整体进行验证……
	@BeforeClass
	public void openUrl() {
	...
	public void test_addGroupInfo() throws InterruptedException {
		...
		Thread.sleep(1000);
		webtest.type("xpath=/html/body/div[1]/div/div/section[2]/div/div[2]/div/div[3]/div/div/form/div[2]/input", "新增分组"+DataActionUtil.getRandomString(3));
		Thread.sleep(1000);
	...
	public void test_showGroupLabel() throws InterruptedException {
		...
		action.moveToElement(parentMenu).perform();
		Thread.sleep(3000);
		WebElement subMenu = webtest.getElementByText("用户标签列表");
		subMenu.click();
		Thread.sleep(3000);
	...
	public void test_addGroupLabel() throws InterruptedException {
		...
		Thread.sleep(1000);
		webtest.typeAndClear("xpath=/html/body/div[1]/div/div/section[2]/div/div[2]/div/div[3]/div/div/form/div[2]/input", "新增分类的标题："+DataActionUtil.getRandomString(5));
		Thread.sleep(1000);
		//状态 选择“未审核”
