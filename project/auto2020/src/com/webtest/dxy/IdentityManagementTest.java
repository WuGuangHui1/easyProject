...
public class IdentityManagementTest extends Admin_Login {
//	@BeforeClass
//	public void openUrl() {
	...
	public void test_startUsing() throws InterruptedException {
		...
		if (text.contains("勾选")) {
			...
			if (text2.contains("系统默认身份")) {
				...
				Assert.assertEquals(text3, "设置成功 页面即将自动跳转~", "启用操作失败");
			}
...
//	@Test(description = "删除", priority = 4)
	...
	public void test_addGroup() throws InterruptedException {
		...
		Thread.sleep(2000);
		// li列表从1开始
		webtest.click("xpath=/html/body/span/span/span/ul/li[2]");
		Thread.sleep(1000);
	...
	public void test_migrateUsers() throws InterruptedException {
		...
		Thread.sleep(1000);
		/*
		 * 不能定位到弹窗元素，获取弹窗内文本信息内容，暂时忽略 WebElement content =
		 * webtest.getElementByXpath("//*[@id='toast-container']/div/div"); String texts
		 * = content.getText();
		 */
	}
	...
	public void test_restart() throws InterruptedException {
		...
		if (texts.contains("没有可操作数据")) {
			Thread.sleep(2000);
			webtest.click(
					"xpath=/html/body/div[1]/div/div/section[2]/div/div[2]/div/div[4]/div/div/form/div[1]/div[2]/select");
			Thread.sleep(1500);
			webtest.click(
					"xpath=/html/body/div[1]/div/div/section[2]/div/div[2]/div/div[4]/div/div/form/div[1]/div[2]/select/option[2]");
			Thread.sleep(2000);
			// 勾选列表项
			webtest.click(
